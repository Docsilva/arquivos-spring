package com.generation.projFarmacia.controller;
...
import com.generation.projFarmacia.repository.CategoriaRepository;
import com.generation.projFarmacia.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	public ResponseEntity<List<Produto>> getByNomeELaboratorio(@PathVariable String nome, @PathVariable String laboratorio){
		return ResponseEntity.ok(produtoRepository.findByNomeFabricante(nome, laboratorio));
	}
